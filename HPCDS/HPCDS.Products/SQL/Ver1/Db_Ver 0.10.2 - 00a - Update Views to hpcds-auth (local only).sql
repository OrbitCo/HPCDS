USE [hpcds-dev]
-- for LocalDb ONLY ------------------------------------------------------------------------
-- Purpose: Change view to point to hpcds-auth and not hpcds-pp-auth, for development purposes
--
-- Applies to: `_hpcds-pp - 2019-05-24b - v0.10.2 vSearchReport w VT-OR-WA.zip` (43 MB)
-- -----------------------------------------------------------------------------------------
GO
/****** Object:  View [dbo].[vUserRoles]    Script Date: 5/29/2019 4:29:27 PM ******/
DROP VIEW [dbo].[vUserRoles]
GO
/****** Object:  View [dbo].[vSearchReport]    Script Date: 5/29/2019 4:29:27 PM ******/
DROP VIEW [dbo].[vSearchReport]
GO
/****** Object:  View [dbo].[vQuestions]    Script Date: 5/29/2019 4:29:27 PM ******/
DROP VIEW [dbo].[vQuestions]
GO
/****** Object:  View [dbo].[vInventoryByOrg]    Script Date: 5/29/2019 4:29:27 PM ******/
DROP VIEW [dbo].[vInventoryByOrg]
GO
/****** Object:  View [dbo].[vInventoryBnPmByChem]    Script Date: 5/29/2019 4:29:27 PM ******/
DROP VIEW [dbo].[vInventoryBnPmByChem]
GO
/****** Object:  View [dbo].[vSearchReportORG]    Script Date: 5/29/2019 4:29:27 PM ******/
DROP VIEW [dbo].[vSearchReportORG]
GO
/****** Object:  View [dbo].[vOrganizations]    Script Date: 5/29/2019 4:29:27 PM ******/
...
GO
	...
	CREATE VIEW [dbo].[vSearchReportORG] AS
...
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[vSearchReport] AS SELECT [OrganizationName]
      ,[ContactUserId]
      ,[DUNSNumber]
      ,[Email]
      ,[PhoneNumber]
