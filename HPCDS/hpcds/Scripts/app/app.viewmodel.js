        ...
        self[options.bindingMemberName] = ko.computed(function () {
            if (!dataModel.getAccessToken()) {
                ...
                if (fragment.access_token) {
                    ...
                    window.location = dataModel.siteUrl + "Account/Authorize?client_id=web&response_type=token&state=" + encodeURIComponent(window.location.hash);
                }
            }
...
var app = new AppViewModel(new AppDataModel(appBaseUrl));
