    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ChangeMyProfileSuccess ? "Your profile has been changed."
                : message == ManageMessageId.ChangeMyOrganizationSuccess ? "Your organization information has been updated." // TODO: (HPCDS-33) Create a message after My Org info was updated successfully
            ...
            var model = SetUserProfileViewModel(); // HPCDS-96 - New read-only view of My Profiles
        ...
        //
        // GET: /Manage/MyOrganization
        [Authorize(Roles = UserRoles.HpcdsUserGroup)]
        ...
        //
        // GET: /Account/MyProfile - for Editing
        [Authorize(Roles = UserRoles.HpcdsUserGroup)]
        public ActionResult MyProfile()
        {
            var model = SetUserProfileViewModel();
            return View(model);
        }
        ...
        private UserProfileViewModel SetUserProfileViewModel()
        {
            ...
            foreach (var q in user.UserQuestions) { model.Qs.Add(new ChallengeQandAViewModel { Q_ID = q.Q_ID, Answer = q.Answer, Question = q.SecurityQuestion.Questions }); }
            model.Organization = user.Organization;
